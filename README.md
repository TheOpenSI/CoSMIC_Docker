...
git clone git@github.com:TheOpenSI/CoSMIC_DB.git
...
- [BE `README.md`](https://github.com/TheOpenSI/CoSMIC_DB/blob/main/README.md)
- [CoSMIC `README.md`](https://github.com/TheOpenSI/CoSMIC/blob/main/README.md)
- [FE `README.md`](https://github.com/TheOpenSI/CoSMIC_UI/blob/main/README.md)
...
**The build process will take a while to fully up depending on your internet connection.**
